...
export const allEvents: Event[] = [
  ...
  },
  {
    ...
    time: "4:00 PM - 5:30 PM HST",
    location: "VIRTUAL",
    description: "Due to conflict with the East Meets West conference we are rescheduling this month's meeting to Thursday April 16. See you at East Meets West This month we are honored to have Alexander García-Tobar, Co-founder & CEO, Valimail (a DigiCert Company) share his insights about Agentic Trust. Who's Knocking? The AI Agent Identity Crisis AI agents are now browsing the web, sending emails, and making decisions on your behalf — but how do you know the agent acting in your systems is actually who it claims to be? Alexander García-Tobar spent a decade solving this exact problem for email. He co-founded Valimail in 2015, built it into the world's leading DMARC email authentication platform with 92,000 clients, and sold it to DigiCert in September 2025 — accumulating a portfolio of 20 patents along the way that prove sender identity at massive scale. Now he's connecting the dots: the same identity gap that made email a phishing free-for-all exists today in the AI agent layer — and it's far more dan",
    ...
    meetupId: "312372203",
    lastSyncedAt: "2026-04-07T19:08:30.959Z",
    syncStatus: "synced",
  },
  {
    id: 15,
