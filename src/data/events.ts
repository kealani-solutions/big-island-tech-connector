...
export const allEvents: Event[] = [
  ...
  },
  {
    ...
    time: "4:00 PM - 5:30 PM HST",
    location: "VIRTUAL",
    description: "** Due to conflict with the East Meets West conference we are rescheduling this month's meeting to the following Thursday April 16. ** The April meetup will be virtual only. RSVP to get the Google Meet link. Big Island Tech Meetup is a community for innovators, entrepreneurs, and technology enthusiasts on the Big Island (and beyond) to connect, collaborate, and learn. We focus on exploring how technology—ranging from renewable energy to artificial intelligence—can solve real-world problems and make life better for everyone. Through engaging discussions, knowledge sharing, and networking, we aim to foster a vibrant ecosystem of creativity and innovation. Whether you’re a seasoned entrepreneur, a technology professional, a curious student, or just someone excited about the possibilities of innovation, this group is for you. If you love learning, sharing ideas, and contributing to a thriving community, we’d love to have you join us. Agenda: • 4:00 - 4:05 PM: Gather and chat while everyone",
    ...
    meetupId: "312372203",
    lastSyncedAt: "2026-04-02T05:35:35.235Z",
    syncStatus: "synced",
  },
  {
    id: 15,
